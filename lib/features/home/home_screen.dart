...
class _HomeScreenState extends State<HomeScreen> {
  ...
  final List<Map<String, dynamic>> _sampleItems = [
    {
      ...
      'description': 'Good condition textbook, used for one semester only.',
    },
    {
      ...
      'condition': 'Fair',
      'co2': '18.5',
      'seller': 'Karim Hossain',
      'emoji': '💻',
      'transaction_type': 'Buy',
      'description': 'Working condition laptop, battery replaced 6 months ago.',
    },
    {
      'title': 'Study Chair',
      'price_display': '৳ 1,200',
      ...
      'description': 'Comfortable study chair available for rent per month.',
    },
    {
      'title': 'Calculus by Stewart',
      'price_display': 'FREE',
      'price': 'FREE',
      'category': 'Books',
      'condition': 'Good',
      ...
      'description': 'Donating this calculus book. Pick up from campus library.',
    },
  ];
            ...
            background: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const Text(
                    'Find eco-friendly deals on campus!',
    ...
    return StreamBuilder<QuerySnapshot>(
      ...
      builder: (context, snapshot) {
        ...
        if (_selectedCategory != 'All') {
          ...
          final filterValue =
              filterMap[_selectedCategory] ?? _selectedCategory;
          items = items
              .where((item) =>
                  (item['category'] ?? '')
                      .toString()
          ...
          return Padding(
            ...
            child: Center(
              child: Column(children: [
                ...
                const SizedBox(height: 12),
                Text(
                  '$_selectedCategory category তে কোনো item নেই',
                  style: const TextStyle(
  ...
  Widget _productCard(Map<String, dynamic> data) {
    ...
    final co2 = data['co2'] ??
        ...
        '0';
    final seller =
        data['seller'] ?? data['seller_name'] ?? 'Anonymous';
    final type =
        data['transaction_type'] ?? data['type'] ?? 'Buy';
            ...
            child: Column(children: [
              ...
              Container(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Column(children: [
                      Text(
                        (co2 / 21.0).toStringAsFixed(1),
                        style: const TextStyle(
                            fontSize: 22,
                            fontWeight: FontWeight.bold,
                            color: AppColors.primary),
                      ),
                      const Text('Trees Saved',
                          style: TextStyle(
                              fontSize: 11, color: AppColors.primaryDark)),
                    ]),
                  ],
              ...
              ...[
                ...
                },
                {
                  ...
                  'route': AppRouter.meetupMap
                },
                {
                  'icon': Icons.leaderboard_outlined,
                  'title': 'Eco Leaderboard',
                  'route': AppRouter.leaderboard
                },
                {
