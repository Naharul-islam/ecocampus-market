    ...
    return Scaffold(
      ...
      body: StreamBuilder<QuerySnapshot>(
        ...
        builder: (context, snapshot) {
            ...
            return Center(
              child: Column(
                ...
                children: [
                  ...
                  const Text('Post your first item to get started!',
                      style:
                          TextStyle(color: AppColors.textSecondary)),
                  const SizedBox(height: 24),
                  ElevatedButton.icon(
                    onPressed: () => Navigator.pushNamed(
                        context, AppRouter.addProduct),
          ...
          // ✅ 'sum' → 'acc' fix (avoid_types_as_parameter_names)
          final totalCo2 = listings
              .fold<double>(0, (acc, d) {
                final data = d.data() as Map<String, dynamic>;
                return acc +
                    ((data['co2_saved'] ?? 0) as num).toDouble();
              })
              .toStringAsFixed(1);

          final activeCount = listings
              .where((d) =>
                  (d.data() as Map)['is_available'] == true)
              .length;
              ...
              Container(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    _statChip('🌱', '$totalCo2 kg', 'CO₂ Saved'),
                  ],
                ),
              ),
              Expanded(
                child: ListView.builder(
                  ...
                  itemBuilder: (context, i) {
                    final data =
                        listings[i].data() as Map<String, dynamic>;
            ...
            child: Row(children: [
              ...
              Expanded(
                ...
                icon: Icon(
                    ...
                    size: 16,
                    color: Colors.orange),
                label: Text(isAvailable ? 'Mark Sold' : 'Relist',
                    style: const TextStyle(
              ...
              Expanded(
                ...
                onPressed: () => _confirmDelete(
                    context, docId, data['title'] ?? 'this item'),
