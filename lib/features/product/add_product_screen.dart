  ...
  Future<void> _submitListing() async {
    ...
    try {
      ...
      await FirebaseFirestore.instance
        ...
        'price': _selectedType == 'Donate'
            ? 0
            : double.tryParse(_priceCtrl.text) ?? 0,
        'price_display': _selectedType == 'Donate'
            ? 'FREE'
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(SnackBar(
          content: Text(
              '🌱 Listed! +${_greenPoints.toStringAsFixed(0)} green points!'),
            ...
            children: [
                  ...
                  child: _selectedImages.isEmpty
                      ? Column(
                          ...
                          children: [
                              ...
                              Text(_categoryEmoji(_selectedCategory),
                                  style:
                ...
                return Expanded(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      color: isSelected
                          ? colors[t]!.withValues(alpha: 0.15)
                          : Colors.white,
              ...
              if (_selectedType != 'Donate')
                TextFormField(
                  ...
                  validator: (v) {
                    if (_selectedType == 'Donate') return null;
                ...
                child: Row(children: [
                  ...
                  Column(
                      ...
                      children: [
                        ...
                        Text(
                            'CO₂ Saved: ${_co2Saved.toStringAsFixed(1)} kg  |  +${_greenPoints.toStringAsFixed(0)} Green Points',
                            style: const TextStyle(
                                fontSize: 12,
                                color: AppColors.primary)),
                      ]),
